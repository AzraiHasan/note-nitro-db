...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, getSession, updateSession, clearSession, getRequestURL, getQuery as getQuery$1, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, readBody, getResponseStatusText } from 'file://C:/Users/ASUS/codejr/note-nitro-db/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://C:/Users/ASUS/codejr/note-nitro-db/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://C:/Users/ASUS/codejr/note-nitro-db/node_modules/devalue/index.js';
import destr from 'file://C:/Users/ASUS/codejr/note-nitro-db/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file://C:/Users/ASUS/codejr/note-nitro-db/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://C:/Users/ASUS/codejr/note-nitro-db/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file://C:/Users/ASUS/codejr/note-nitro-db/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://C:/Users/ASUS/codejr/note-nitro-db/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://C:/Users/ASUS/codejr/note-nitro-db/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://C:/Users/ASUS/codejr/note-nitro-db/node_modules/hookable/dist/index.mjs';
import { klona } from 'file://C:/Users/ASUS/codejr/note-nitro-db/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file://C:/Users/ASUS/codejr/note-nitro-db/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file://C:/Users/ASUS/codejr/note-nitro-db/node_modules/defu/dist/defu.mjs';
import { hash } from 'file://C:/Users/ASUS/codejr/note-nitro-db/node_modules/ohash/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/ASUS/codejr/note-nitro-db/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/ASUS/codejr/note-nitro-db/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/ASUS/codejr/note-nitro-db/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file://C:/Users/ASUS/codejr/note-nitro-db/node_modules/consola/dist/index.mjs';
import { getContext } from 'file://C:/Users/ASUS/codejr/note-nitro-db/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://C:/Users/ASUS/codejr/note-nitro-db/node_modules/errx/dist/index.js';
import { isVNode, version as version$1, unref } from 'file://C:/Users/ASUS/codejr/note-nitro-db/node_modules/vue/index.mjs';
import { createKindeServerClient, GrantType, validateClientSecret } from 'file://C:/Users/ASUS/codejr/note-nitro-db/node_modules/@kinde-oss/kinde-typescript-sdk/dist/index.js';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file://C:/Users/ASUS/codejr/note-nitro-db/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://C:/Users/ASUS/codejr/note-nitro-db/node_modules/@unhead/shared/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "public": {},
  "kinde": {
    "password": "239b25b130344660b623d78af64c1093",
    "cookie": {
      "sameSite": "lax",
      "secure": false,
      "httpOnly": true
    ...
    "authDomain": "",
    "clientId": "8059f86b8af6413a8803383d931fc752",
    "redirectURL": "",
    "logoutRedirectURL": "",
    "postLoginRedirectURL": "http://localhost:3000/dashboard",
    "clientSecret": "1mF9rRWfP8cNZL223YBZvSoINKKpwUGTQaHN6cZyNZV815mVjZi",
    "audience": ""
  }
};
const envOptions = {
...
const serverAssets = [{"baseName":"server","dir":"C:/Users/ASUS/codejr/note-nitro-db/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\ASUS\\codejr\\note-nitro-db","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\ASUS\\codejr\\note-nitro-db\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\ASUS\\codejr\\note-nitro-db\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\ASUS\\codejr\\note-nitro-db\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\Users\\ASUS\\codejr\\note-nitro-db\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _Kv5nyjCe5D = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "C:/Users/ASUS/codejr/note-nitro-db";
...
const _ek9t9u = defineEventHandler(async (event) => {
...
const config = useRuntimeConfig();
const _80hljs = defineEventHandler(async (event) => {
...
const _tXdNXk = defineEventHandler(async (event) => {
...
const _KLUhRD = defineEventHandler(async (event) => {
  const { kinde: kindeSettings } = useRuntimeConfig();
  const query = getQuery$1(event);
  const sessionManager = event.context.kinde.sessionManager;
  if (query.postLoginRedirectURL) {
  ...
  const registerURL = await getKindeClient().register(sessionManager, {
    authUrlParams: {
      audience: kindeSettings.audience,
      ...query
    }
...
const _2AgcnS = defineEventHandler(() => {
...
const _i6nJmz = defineEventHandler(async (event) => {
...
const _lazy_1Q70oQ = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_1Q70oQ, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _ek9t9u, lazy: false, middleware: true, method: undefined },
  { route: '/api/callback', handler: _80hljs, lazy: false, middleware: false, method: "get" },
  { route: '/api/login', handler: _tXdNXk, lazy: false, middleware: false, method: "get" },
  { route: '/api/register', handler: _KLUhRD, lazy: false, middleware: false, method: "get" },
  { route: '/api/health', handler: _2AgcnS, lazy: false, middleware: false, method: "get" },
  { route: '/api/logout', handler: _i6nJmz, lazy: false, middleware: false, method: "get" },
  { route: '/**', handler: _lazy_1Q70oQ, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://C:/Users/ASUS/codejr/note-nitro-db/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://C:/Users/ASUS/codejr/note-nitro-db/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
